...
|----------------------------------------|--------------------------------------------------------------------|
| [`href`](#html-hyperlinks)             | Specifies the destination address of the link.                     |
| [`target`](#target-attribute)          | Specifies where to open the link document.                         |
| [`title`](#use-image-as-a-links)       | Specifies extra information about an element.                      |
| [`id`](#bookmark-hyperlinks)           | Used to allow readers to jump to specific parts of a web page.     |

<MDXSeparator />

| Style Properties                       | Definition                                                                                                                |
|----------------------------------------|---------------------------------------------------------------------------------------------------------------------------|
| [`padding`](#padding-property)         | Specifies where to open the link document.used to create space around an element’s content, inside of any defined borders.|
| [`overflow`](#overflow-property)       | Specifies what should happen if content overflows an element’s box.                                                       |
