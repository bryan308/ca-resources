...
- The following values below explains how to change the marker for unordered list items.
  ...
  1. The **circle** value sets the list item marker to a circle.
  1. The **square** value sets the list item marker to a square.
  1. The **none** value will not display markers on list items.
</section>
<section>
#### Disc value
...
- The following values sets the marker for ordered list items.
  ...
  1. The **upper-alpha** value is used to set the marker of a list item in lowercase letters.
  1. The **lower-roman** value is used to set the marker of a list item in lowercase roman numbers.
  1. The **upper-roman** value is used to set the marker of a list item in lowercase roman numbers.
