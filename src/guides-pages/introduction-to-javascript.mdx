...
<p className="text-muted-foreground text-sm">8–11 MIN READ</p>
</section>
<section>
## Agenda
1. Introduction to JavaScript
1. What JavaScript can do?
1. Where to insert JavaScript?
1. General rules in writing JavaScript
1. Displaying output using JavaScript
