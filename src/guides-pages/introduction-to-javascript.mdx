...
description: JavaScript, invented by Brendan Eich in 1995, is a scripting language that enables users to create dynamic features on web pages. It allows users to store variables, manipulate text, and run code in response to events. Though often confused with Java, JavaScript is entirely different in both concept and design. It became an ECMA standard in 1997, with ECMAScript as the official language name, governed by the ECMA-262 specification.
...
- JavaScript code can be grouped together in blocks by placing them inside curly brackets.
  ```JS
  function myFunction() {
    document.getElementById("demo1").innerTHML = "Hello everyone!";
    document.getElementById("demo2").innerTHML = "How are you?";
  }
  ```
</section>
<section>
...
<html>
  <body>
    ...
    <p>My First Paragraph.</p>
    <script>
      document.alert("This is an alert box!");
    </script>
  </body>
</html>
```
  ...
  <body>
    ...
    <script>
      /*
        ...
        and the paragraph with id = "mayP"
      */
      document.getElementById("myH") = "JavaScript Comments";
      document.getElementById("myP") = "My First Paragraph";
    </script>
