...
|------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| [`action`](#html-form-attributes)                                | Defines the action to be performed when the form is submitted.                                         |
...
| [`autofocus`](#the-placeholder-required-and-autofocus)           | Specifies that an input field should automatically should focus when the page loads.                   |
