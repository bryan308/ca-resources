...
export function ModeToggle() {
	...
	const loadedTheme = theme || 'system';
	return (
		<>
			<div className='hidden xl:block'>
				<div className='flex rounded-full border primary-border'>
					{/* System */}
					<div
						onClick={() => setTheme('system')}
						className={`flex items-center justify-center p-2 rounded-full cursor-pointer hover:text-neutral-700 dark:hover:text-neutral-300 ${
							loadedTheme === 'system'
								? 'text-100 primary-border border'
