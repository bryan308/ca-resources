...
export default function HomePage() {
	return (
		<div className="mx-2 md:mdx-0">
			<div className="m-0 md:mt-10" />
			<Section className="relative flex h-[500px] items-center justify-center border-b-0">
			...
			<Section className="p-10 border-b-0">
...
const Section = ({ children, className }: { children: ReactNode; className?: string }) => {
	return (
		<div
			className={cn(className, "relative max-w-6xl mx-auto border bg-background/80 p-6 md:p-10")}
		>
			{children}
		</div>
	)
