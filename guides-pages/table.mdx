...
| **Styles**       | **Definition**                                                                              |
|------------------|---------------------------------------------------------------------------------------------|
| `border-style`   | Sets the style of the table border (e.g., solid, dashed).                                   |
| `border-width`   | Sets the width of the table border (e.g., thin, medium).                                    |
| `border`         | Shorthand property for `border-style`, `border-width`, and `border-color`.                  |
| `padding`        | Sets the space between the cell content and its border.                                     |
| `border-collapse`| Collapses table borders into a single border.                                               |
| `text-align`     | Sets the horizontal alignment of content in `<th>` and `<td>` elements.                     |
| `vertical-align` | Sets the vertical alignment of content in `<th>` and `<td>` elements (top, middle, bottom). |
| `:hover`         | Selector to apply styles to table rows (`<tr>`) on mouseover.                               |
</SummaryTable>
</section>
<section>
### Credits
