...
<div className="grid gap-4" style={{ gridTemplateColumns: "repeat(3, minmax(0, 1fr))" }}>
  <GuideImage src='/guides/images/giphy-1.gif' alt='GIF example 1' width={240} height={240} maxWidth="20%"/>
  <GuideImage src='/guides/images/giphy-2.gif' alt='GIF example 2' width={480} height={480} maxWidth="20%"/>
  <GuideImage src='/guides/images/giphy-3.gif' alt='GIF example 3' width={480} height={480} maxWidth="20%"/>
</div>
<MDXSeparator />
...
<body>
  <img src="https://onlinejpgtools.com/images/examples-onlinejpgtools/sunflower.jpg" alt="Sunflower" />
</body>
```
<MDXSeparator />
### Relative URL
...
<div style={{margin: "8px 0", border: "3px hsl(var(--foreground))", borderStyle: "dotted dashed solid double" }}>An outside border. The effect depends on the border-color value</div>
</section>
<section>
...
<section>
### link attributes used to create a Favicon
