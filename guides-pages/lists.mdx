...
<MDXSeparator />
#### Output:
<OrderedList type="lower-alpha" listStyle="type" />
</section>
<section>
#### Upper alpha value
```HTML {3} showLineNumbers
...
<MDXSeparator />
#### Output:
<OrderedList type="upper-alpha" listStyle="type" />
</section>
<section>
#### Lower roman value
```HTML {3} showLineNumbers
...
<MDXSeparator />
#### Output:
<OrderedList type="lower-roman" listStyle="type" />
</section>
<section>
#### Upper roman value
```HTML {3} showLineNumbers
...
<MDXSeparator />
#### Output:
<OrderedList type="upper-roman" listStyle="type" />
</section>
<section>
