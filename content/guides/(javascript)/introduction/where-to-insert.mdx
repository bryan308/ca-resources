...
description: Learn where and how to place JavaScript in your HTML.
---
  ...
  <head>
    <script> // [!code ++]
      function myFunction() { // [!code ++]
        document.getElementById("demo").innerHTML = "Paragraph changed!"; // [!code ++]
      } // [!code ++]
    </script> <!-- [!code ++] -->
  </head>
  <body>
...
<html>
  <body>
    ...
    <script src="js/myScript.js"></script> <!-- [!code ++] -->
  </body>
</html>
```
