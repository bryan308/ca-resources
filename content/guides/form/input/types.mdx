...
All examples below are using the **shadcn/ui** label and input for minimalist and modern design. See [shadcn](https://www.shadcn.com/).
...
<div className="grid w-full max-w-sm items-center gap-1.5 mt-4 min-w-[300px]">
