...
<Image src="/guides/overview/html-structure.png" alt="HTML Structure" width={563} height={500} className="m-0 rounded-md w-full max-w-2xl" />

<p className="text-center mt-4 text-foreground">html structure by [Online Design Teacher](https://www.onlinedesignteacher.com/2016/03/the-html-template.html)</p>
